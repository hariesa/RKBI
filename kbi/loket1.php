...
<table width="85%" border="1" cellspacing="2" cellpadding="2">
  <tr>
    <td width="22%">Registration Number Online</td>
    <td width="5%">:</td>
    <td width="73%"><label for="textfield"></label>
    <input type="text" name="textfield" id="textfield" /></td>
  </tr>
  <tr>
    <td>Tanggal Registrasi Online</td>
    <td>:</td>
...
<table width="85%" border="1" cellspacing="2" cellpadding="2">
  <tr>
    ...
    <td colspan="2">Status System</td>
    <td colspan="2">Status Manual</td>
    <td width="16%" rowspan="2">Keterangan</td>
  </tr>
  <tr>
    <td width="6%">Ada</td>
    <td width="5%">Tidak</td>
  ...
  <tr>
    ...
    <td align="center"><input type="radio" name="radio" id="radio" value="radio" />
...
<p>
  ...
  <input type="button" onclick="location.href='loket2.php';" value="Simpan" />
</p>
</body>
</html>